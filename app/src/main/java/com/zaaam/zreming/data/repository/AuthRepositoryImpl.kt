...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun login(username: String, password: String, deviceId: String, deviceName: String?): UserDto {
        val result = safeCall { api.login(LoginRequest(username, password, deviceId, deviceName)) }
