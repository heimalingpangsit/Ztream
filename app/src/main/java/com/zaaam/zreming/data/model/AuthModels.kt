...
data class LoginRequest(
    val username: String,
    val password: String,
    // HWID: fingerprint device ini. Tanpa ini backend gak akan pernah bisa tau
    // "device keberapa" yang lagi login, jadi limit 1 HP (member) / 5 HP
    // (member+) gak akan pernah bisa ditegakkan. Lihat DeviceIdProvider.kt.
    val deviceId: String,
